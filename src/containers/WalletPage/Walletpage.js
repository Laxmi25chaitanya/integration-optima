                ...
                <div>
                    ...
                    <div className="Main">
                        ...
                        <div className="cardInfo1">
                            <img id="myImg" src={`./homeassets/${bank.banks[0].cardimage}`} width="310" height="120"
                                 alt="Card1"/>
                        ...
                        <div className="cardInfo2">
                            <img id="myImg1" src={`./homeassets/${bank.banks[1].cardimage}`} width="287" height="120"
                                 alt="Card2"/>
                        ...
                        <div className="cardInfo2">
                            <img id="myImg1" src={`./homeassets/${bank.banks[2].cardimage}`} width="287" height="120"
                                 alt="Card2"/>
